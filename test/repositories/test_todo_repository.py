...
class TestTodoRepository:
    ...
    def test_a_todo_registration_saves_count_is_one(self, todo_repository: TodoRepository):
        ...
        todo = Todo(title='Mow the Lawn', assigned_to="1", position=1, task_id=1)
    ...
    def test_2_todo_registration_saves_count_is_two(self, todo_repository: TodoRepository):
        todo = Todo(title='Update New Request', assigned_to="1", position=1, task_id=1)
        todo_repository.save(todo)

        todo_two = Todo(title='Work On EndPoint', assigned_to="2", position=1, task_id=1)
    ...
    def test_delete_a_todo_from_2_total_saves_count_is_one(self, todo_repository: TodoRepository):
        todo = Todo(title='Work On Services', assigned_to="1", position=1, task_id=1)
        todo_repository.save(todo)

        todo_two = Todo(title='Work On Repository', assigned_to="1", position=1, task_id=1)
        todo_repository.save(todo_two)
    ...
    def test_find_by_id(self, todo_repository: TodoRepository):
        todo = Todo(title='Work on TodoRepository', assigned_to="1", position=1, task_id=1)
        todo_repository.save(todo)
        assert todo_repository.count() == 1
    ...
    def test_find_by_todo_title(self, todo_repository: TodoRepository):
        todo = Todo(title='Work On Derailing THe Gutters', assigned_to="1", position=1, task_id=1)
        todo_repository.save(todo)
